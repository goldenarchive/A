...
#define START_MASTERNODE_PAYMENTS_TESTNET 1532132263
#define START_MASTERNODE_PAYMENTS 1532132263

static const int64_t DARKSEND_COLLATERAL = (1.00*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN); //stop Shadownodes

static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 A per COIN
static const int64_t TARGET_SPACING = 60;
static const int64_t STAKE_TIMESPAN_SWITCH_TIME = 1532132263; //this is old, but works due to being lower than the present time
...
static const unsigned int MAX_BLOCK_SIZE = 400000;//400kB //each transaction being about 0.5kB / 800 transactions 
/** The maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/2;
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 5000;
...
public:
    ...
    {
        // A: the coin stake transaction is marked with the first output empty
